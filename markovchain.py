...
class MarkovChain:
    ...
    def save_kwargs(self, **kwargs):
        ...
        self.transparency_func = self.kwargs.get("transparency_func", lambda p: 1)
    ...
    def add_arrow(self, ax,
        ...
        if prob and annotate:
            text = f"{prob*100 if self.percentages else prob:.3f}".rstrip("0").rstrip(".")
